...
\section{Comparación de las Cópulas Ajustadas}


\begin{figure}[H]
 \centering
  \subfloat[Mujeres $C_{12}$]{
   \label{CNMC12}
    \includegraphics[width=0.3\textwidth]{4img/CdeNMujC12.png}}
  \subfloat[Hombres $C_{12}$]{
   \label{CNHC12}
    \includegraphics[width=0.3\textwidth]{4img/CdeNHomC12.png}}
  \subfloat[Total $C_{12}$]{
   \label{CNTC12}
    \includegraphics[width=0.3\textwidth]{4img/CdeNTotalC12.png}}
\end{figure}

\begin{figure}[H]
\centering
  \subfloat[Mujeres $C_{23}$]{
   \label{CNMC23}
    \includegraphics[width=0.3\textwidth]{4img/CdeNMujC23.png}}
  \subfloat[Hombres $C_{23}$]{
   \label{CNHC23}
    \includegraphics[width=0.3\textwidth]{4img/CdeNHomC23.png}}
  \subfloat[Total $C_{23}$]{
   \label{CNTC23}
    \includegraphics[width=0.3\textwidth]{4img/CdeNTotalC23.png}}
\end{figure}

\begin{figure}[H]
\centering
  \subfloat[Mujeres $C_{34}$]{
   \label{CNMC34}
    \includegraphics[width=0.3\textwidth]{4img/CdeNMujC34.png}}
  \subfloat[Hombres $C_{34}$]{
   \label{CNHC34}
    \includegraphics[width=0.3\textwidth]{4img/CdeNHomC34.png}}
  \subfloat[Total $C_{34}$]{
   \label{CNTC34}
    \includegraphics[width=0.3\textwidth]{4img/CdeNTotalC34.png}}
\end{figure}

\begin{figure}[H]
\centering
  \subfloat[Mujeres $C_{45}$]{
   \label{CNMC45}
    \includegraphics[width=0.3\textwidth]{4img/CdeNMujC45.png}}
  \subfloat[Hombres $C_{45}$]{
   \label{CNHC45}
    \includegraphics[width=0.3\textwidth]{4img/CdeNHomC45.png}}
  \subfloat[Total $C_{45}$]{
   \label{CNTC45}
    \includegraphics[width=0.3\textwidth]{4img/CdeNTotalC45.png}}
    \caption{Comparación de las curvas de nivel, nivel $1$.}
    \label{fig:CdeNNivel1}
\end{figure}
...
\begin{figure}[H]
 \centering
  \subfloat[Mujeres $C_{13|2}$]{
   \label{CNMC13.2}
    \includegraphics[width=0.3\textwidth]{4img/CdeNMujC13.2.png}}
  \subfloat[Hombres $C_{13|2}$]{
   \label{CNHC13.2}
    \includegraphics[width=0.3\textwidth]{4img/CdeNHomC13.2.png}}
  \subfloat[Total $C_{13|2}$]{
   \label{CNTC13.2}
    \includegraphics[width=0.3\textwidth]{4img/CdeNTotalC13.2.png}}
\end{figure}

\begin{figure}[H]
\centering
  \subfloat[Mujeres $C_{24|3}$]{
   \label{CNMC24.3}
    \includegraphics[width=0.3\textwidth]{4img/CdeNMujC24.3.png}}
  \subfloat[Hombres $C_{24|3}$]{
   \label{CNHC24.3}
    \includegraphics[width=0.3\textwidth]{4img/CdeNHomC24.3.png}}
  \subfloat[Total $C_{24|3}$]{
   \label{CNTC24.3}
    \includegraphics[width=0.3\textwidth]{4img/CdeNTotalC24.3.png}}
\end{figure}

\begin{figure}[H]
\centering
  \subfloat[Mujeres $C_{35|4}$]{
   \label{CNMC35.4}
    \includegraphics[width=0.3\textwidth]{4img/CdeNMujC35.4.png}}
  \subfloat[Hombres $C_{35|4}$]{
   \label{CNHC35.4}
    \includegraphics[width=0.3\textwidth]{4img/CdeNHomC35.4.png}}
  \subfloat[Total $C_{35|4}$]{
   \label{CNTC35.4}
    \includegraphics[width=0.3\textwidth]{4img/CdeNTotalC35.4.png}}
    \caption{Comparación de las curvas de nivel, nivel $2$.}
    \label{fig:CdeNNivel2}
\end{figure}
...
\begin{figure}[H]
 \centering
  \subfloat[Mujeres $C_{14|23}$]{
   \label{CNMC14.23}
    \includegraphics[width=0.3\textwidth]{4img/CdeNMujC14.23.png}}
  \subfloat[Hombres $C_{14|23}$]{
   \label{CNHC14.23}
    \includegraphics[width=0.3\textwidth]{4img/CdeNHomC14.23.png}}
  \subfloat[Total $C_{14|23}$]{
   \label{CNTC14.23}
    \includegraphics[width=0.3\textwidth]{4img/CdeNTotalC14.23.png}}
\end{figure}

\begin{figure}[H]
\centering
  \subfloat[Mujeres $C_{25|34}$]{
   \label{CNMC25.34}
    \includegraphics[width=0.3\textwidth]{4img/CdeNMujC25.34.png}}
  \subfloat[Hombres $C_{25|34}$]{
   \label{CNHC25.34}
    \includegraphics[width=0.3\textwidth]{4img/CdeNHomC25.34.png}}
  \subfloat[Total $C_{25|34}$]{
   \label{CNTC25.34}
    \includegraphics[width=0.3\textwidth]{4img/CdeNTotalC25.34.png}}
    \caption{Comparación de las curvas de nivel, nivel $3$.}
    \label{fig:CdeNNivel3}
\end{figure}
...
\begin{figure}[H]
 \centering
  \subfloat[Mujeres $C_{15|234}$]{
   \label{CNMC15.234}
    \includegraphics[width=0.3\textwidth]{4img/CdeNMujC15.234.png}}
  \subfloat[Hombres $C_{15|234}$]{
   \label{CNHC15.234}
    \includegraphics[width=0.3\textwidth]{4img/CdeNHomC15.234.png}}
  \subfloat[Total $C_{15|234}$]{
   \label{CNTC15.234}
    \includegraphics[width=0.3\textwidth]{4img/CdeNTotalC15.234.png}}
    \caption{Comparación de las curvas de nivel, nivel $4$.}
    \label{fig:CdeNNivel5}
\end{figure}
