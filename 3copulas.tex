...
\begin{algorithm}[H]
      ...
      \label{algbackward}
      \begin{algorithmic}[1]  
        \Require{Data frame con los observaciones obtenidas del forward, $dataU$; lista con las funciones $h$ ajustadas en el forkward, $hs$ ; lista que contiene las cópulas ajustadas en el forward,  $copulas$; nivel de confiabilidad; $\alpha$.}
