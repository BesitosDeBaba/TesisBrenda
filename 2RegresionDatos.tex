...
\section{Regresión Cuantil}
    ...
    El $\tau$-ésimo cuantil se puede calcular al minimizar la función de pérdida evaluada en $X-u$ con respecto a $u$ como se muestra en la ecuación \eqref{minCun} \cite{Koenker2005}
