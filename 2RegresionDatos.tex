...
\section{Regresión Cuantil}
    ...
    y para el caso empírico la fórmula queda de la siguiente manera, 
...
\begin{obs}[Regresión Cuantil Lineal]
    ...
    $\tau$ corresponde al $\tau$-ésimo cuantil de error con respecto a la variable respuesta, es decir, $Q(\varepsilon_{i, \tau}) = 0$. Entonces, usando la fórmula \eqref{qestima} se obtiene la siguiente ecuación.
...
Así la profundidad muestral de banda de la gráfica $y(t)$ está determinada por, 
...
Finalmente, para $J = 4$, se tiene que la única banda es $B(x_1, x_2, x_3, x_4)$ que contiene a todas las curvas. Porque el valor de profundidad de cada variable es:
...
Como se detallará más exhaustivamente en el Capítulo \ref{Resultados}, una parte de la base de datos consiste en mediciones de glucosa e insulina tomadas durante la Prueba de Tolerancia a la Glucosa Oral en los minutos $0$, $30$, $60$, $90$ y $120$. Estos constituyen los datos funcionales con los que se hará inferencia para proporcionar la probabilidad de padecer diabetes. 
...
Defínase el punto $\widetilde{TBD} = (\widetilde{TBD^g}, \widetilde{TBD_{\eta}})$ que representa los valores límite aceptables de glucosa e insulina para pacientes completamente sanos. A partir del punto $(\widetilde{TBD^g},\widetilde{TBD^{\eta}})$ se define la función cuadrante para cada observación como:
